                ...
                <div class="container py-sm-3">
                    <div class="row footer-grids">
                        <div class="col-lg-3 col-sm-6 mb-lg-0 mb-sm-5 mb-4">
                            <h2> <a class="navbar-brand mb-3" href="index.html">Nepali Handicraft</a>
                            </h2>
                        ...
                        <div class="col-lg-3 col-sm-6 mb-md-0 mb-sm-5 mb-4">
                            ...
                            <p><span class="fa mr-2 fa-map-marker"></span>Sunakothi 26, <span>Lalitpur, NP.</span></p>
                            <p class="phone py-2"><span class="fa mr-2 fa-phone" style="transform: rotateZ(180deg);"></span> +977-9843324021 </p>
                            <p><span class="fa mr-2 fa-envelope"></span><a href="mailto:devish@devish.com.np">admin@nepalihandicraft.com</a></p>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            ...
                            <form action="actions/subscriber-action.php" method="post" class="d-flex newsletter-w3pvt">
                                <input type="email" id="email" name="subscribe-email" placeholder="Enter your email here" required="">
                                <button type="submit" class="btn" name="subscribe-submit">Subscribe</button>
                            </form>
                            <div class="icon-social mt-4">
                                <a href="https://www.facebook.com" target="_blank" class="button-footr">
                                    <i class="mx-2 fab fa-facebook-f"></i>
                                </a>
                                <a href="https://www.twitter.com" target="_blank" class="button-footr">
                                    <i class="mx-2 fab fa-twitter"></i>
                                </a>
                                <a href="https://www.youtube.com" target="_blank" class="button-footr">
            ...
            <div class="copy_right p-3 d-flex justify-content-around">
                <p>&copy; 2019 Nepali Handicraft (Information Management System). All Rights Reserved.</p>
                <!-- move top -->
                <div class="move-top">
                    <a href="#wrapper">
